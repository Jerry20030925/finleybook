...
import { ChevronRight, Home, FileText, Scale, ArrowUp } from 'lucide-react'
                ...
                {t.sections.map((section, index) => (
                  ...
                  >
                    ...
                    {section.subsections && section.subsections.map((sub, subIndex) => (
                      <div key={subIndex} className="mb-8 pl-4 border-l-2 border-amber-100">
                    ...
                    {section.contactInfo && (
                      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-lg p-8 mt-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                          {Object.entries(section.contactInfo).map(([key, info]) => (
                            <div key={key} className={`${key === 'address' ? 'md:col-span-2' : ''} bg-white rounded-lg p-4 shadow-sm`}>
                              <h5 className="font-semibold text-amber-700 mb-2">{info.title}</h5>
