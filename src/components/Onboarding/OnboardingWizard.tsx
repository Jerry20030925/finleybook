                    ...
                    {step === 3 && (
                        ...
                        >
                            ...
                            <p className="text-gray-600 mb-8">
                                {t('onboarding.final.desc')}
                            </p>

                            <button
                                onClick={handleSignup}
                                disabled={isSigningUp}
                                className={`w-full bg-indigo-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-indigo-700 transition-colors flex items-center justify-center gap-2 ${isSigningUp ? 'opacity-70 cursor-not-allowed' : ''}`}
                            >
                                {isSigningUp ? (
                                    <>
