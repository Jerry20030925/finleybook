...
import { XMarkIcon, EyeIcon, EyeSlashIcon, SparklesIcon, PhoneIcon } from '@heroicons/react/24/outline'
                  ...
                  >
                    ...
                    {!showPhoneForm && (
                      <button
                        ...
                        disabled={loading}
                        className="w-full mt-3 group relative overflow-hidden bg-white border-2 border-gray-200 rounded-2xl px-6 py-4 text-gray-700 font-medium hover:border-gray-300 focus:outline-none focus:ring-4 focus:ring-gray-100 transition-all duration-200 shadow-sm hover:shadow-md disabled:opacity-50"
                      >
                        <div className="absolute inset-0 bg-gradient-to-r from-green-50 via-emerald-50 to-teal-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200 rounded-2xl" />
                        <div className="relative flex items-center justify-center">
                        ...
                        <form onSubmit={handlePhoneSignIn} className="space-y-6">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500 outline-none bg-white/50 backdrop-blur-sm"
                              placeholder="+1 555 555 5555"
                              required
                            />
                            <p className="mt-2 text-xs text-gray-500">Include country code (e.g. +1)</p>
                          </div>
                          <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-gradient-to-r from-violet-600 to-indigo-600 text-white font-semibold py-4 rounded-2xl shadow-lg hover:shadow-xl disabled:opacity-50"
                          >
                        ...
                        <form onSubmit={handleVerifyCode} className="space-y-6">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-3.5 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-violet-500 outline-none bg-white/50 backdrop-blur-sm text-center text-2xl tracking-widest"
                              placeholder="123456"
                              maxLength={6}
                              required
                            />
